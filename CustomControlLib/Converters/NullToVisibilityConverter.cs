namespace KXControls.Converters
{
    using System;
    ...
    /// <summary>
    /// Converts a null value to Visibility.Visible and any other value to Visibility.Hidden
    /// </summary>
    public class NullToVisibilityConverter2
        : IValueConverter
    {
        /// <summary>
        /// Converts a value.
